...
$string['chooseendyear'] = 'Choose graduation year...';
$string['class'] = 'Class';
...
$string['confirmdeleteendyear'] = 'Delete the graduation year \'{$a}\'?';
$string['confirmdeleteendyearfull'] = 'Are you sure you want to delete the graduation year \'{$a}\'? This action is irreversible and all classes including results will be permanently removed.';
$string['confirmdeleteuser'] = 'Delete the results of {$a}?';
$string['confirmdeleteuserfull'] = 'Are you sure you want to delete the results of the user(s) {$a}? This action is irreversible and they will be removed from their class, in addition to the permanent deletion of their results.';
...
$string['createclasstounlock'] = 'Enter a class name, gender, age group and graduation year to create a class and to unlock managing classes.';
$string['createnewclass'] = 'Create a new class';
$string['createnewtest'] = 'Create a new test';
$string['deleteendyearresults'] = 'Delete graduation year\'s results';
$string['deleteresults'] = 'Delete FitCheck results';
$string['deleteuserresults'] = 'Delete user\'s results';
$string['deleteuserresultsplural'] = 'Delete users\' results';
...
$string['endyeartitle'] = 'Graduation year';
...
$string['status_help'] = 'The status of the test determines whether or not students of any class can view and take the test. Default = on';
$string['status'] = 'Status';
$string['step_help'] = 'The result interval of the test. This value defines what results are valid. Examples: An interval of 0.01 allows results up to hundredths, an interval of 1 allows for all whole numbers and an interval 25 allows for results only divisible by 25.';
$string['step'] = 'Interval';
